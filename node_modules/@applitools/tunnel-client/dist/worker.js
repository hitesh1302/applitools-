...
function makeTunnelClientWorker({ settings, logger: defaultLogger, }) {
    ...
    function startEcHealthCheck() {
        ...
        const ecServerUrl = (_b = process.env.APPLITOOLS_EG_TUNNEL_MANAGER_URL) !== null && _b !== void 0 ? _b : (settings.region === 'australia-southeast' ? 'https://exec-au.applitools.com' : 'https://exec-wus.applitools.com');
